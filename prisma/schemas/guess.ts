...
import { CompleteGame, CompleteParticipant, relatedGameSchema, relatedParticipantSchema } from './index';
 ...
 */
export const relatedGuessSchema: z.ZodSchema<CompleteGuess> = z.lazy(() =>
  guessSchema.extend({
